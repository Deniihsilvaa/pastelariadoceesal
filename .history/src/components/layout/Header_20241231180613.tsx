...
export function Header() {
  ...
  return (
    <div className="flex items-center justify-between p-4 mx-auto space-x-6 shadow-md max-w-7xl sm:flex-col md:flex-row">
      <div className="flex items-center justify-center h-16 px-4 mx-auto max-w-7xl">
        {/* Logo */}
        <Link to="/" className="flex justify-end gap-5 space-x-6">
          <div className="flex items-center justify-end w-10 h-10 bg-red-500 rounded-full">
